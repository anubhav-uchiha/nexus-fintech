...
export type IdempotencyRecordWhereInput = {
  ...
  identityId?: Prisma.StringFilter<"IdempotencyRecord"> | string
  operation?: Prisma.StringFilter<"IdempotencyRecord"> | string
  ...
  response?: Prisma.JsonNullableFilter<"IdempotencyRecord">
...
export type IdempotencyRecordWhereUniqueInput = Prisma.AtLeast<{
  idempotencyKey?: string
  identityId_operation_idempotencyKey?: Prisma.IdempotencyRecordIdentityIdOperationIdempotencyKeyCompoundUniqueInput
  AND?: Prisma.IdempotencyRecordWhereInput | Prisma.IdempotencyRecordWhereInput[]
  OR?: Prisma.IdempotencyRecordWhereInput[]
  NOT?: Prisma.IdempotencyRecordWhereInput | Prisma.IdempotencyRecordWhereInput[]
  identityId?: Prisma.StringFilter<"IdempotencyRecord"> | string
  ...
  createdAt?: Prisma.DateTimeFilter<"IdempotencyRecord"> | Date | string
  expiresAt?: Prisma.DateTimeFilter<"IdempotencyRecord"> | Date | string
}, "idempotencyKey" | "identityId_operation_idempotencyKey">
...
export type IdempotencyRecordScalarWhereWithAggregatesInput = {
  ...
  identityId?: Prisma.StringWithAggregatesFilter<"IdempotencyRecord"> | string
  operation?: Prisma.StringWithAggregatesFilter<"IdempotencyRecord"> | string
  ...
  response?: Prisma.JsonNullableWithAggregatesFilter<"IdempotencyRecord">
...
export type IdempotencyRecordIdentityIdOperationIdempotencyKeyCompoundUniqueInput = {
  identityId: string
  operation: string
  idempotencyKey: string
}
...
export type IdempotencyRecordOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"idempotencyKey" | "identityId" | "operation" | "requestHash" | "status" | "response" | "statusCode" | "createdAt" | "expiresAt", ExtArgs["result"]["idempotencyRecord"]>
...
export interface IdempotencyRecordDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const idempotencyRecordWithIdempotencyKeyOnly = await prisma.idempotencyRecord.findMany({ select: { idempotencyKey: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many IdempotencyRecords and only return the `idempotencyKey`
   * const idempotencyRecordWithIdempotencyKeyOnly = await prisma.idempotencyRecord.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more IdempotencyRecords and only return the `idempotencyKey`
   * const idempotencyRecordWithIdempotencyKeyOnly = await prisma.idempotencyRecord.updateManyAndReturn({
   *   select: { idempotencyKey: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface IdempotencyRecordFieldRefs {
  ...
  readonly identityId: Prisma.FieldRef<"IdempotencyRecord", 'String'>
  readonly operation: Prisma.FieldRef<"IdempotencyRecord", 'String'>
  ...
  readonly response: Prisma.FieldRef<"IdempotencyRecord", 'Json'>
