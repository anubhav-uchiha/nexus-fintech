/*
  ...
  - A unique constraint covering the columns `[userId,idempotencyKey]` on the table `transactions` will be added. If there are existing duplicate values, this will fail.
